...
const News = (props)=> {
    ...
    const fetchMoreData=async()=>{
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=dbe57b028aeb41e285a226a94865f7a7&page=${this.state.page}&pageSize=${props.pageSize}`;
        setPage(page+1)
        // setLoading(true)
        let data = await fetch(url);
        let parsedData = await data.json()
